...
async def _(event):
    ...
    try:
        ...
        await hel_.edit("__Searching for__ `{}`".format(angel))
        # Credits to catuserbot.
        # Ported to angelbot and beautifications by @ForGo10God.
        movies = imdb.search_movie(angel)
...
<b>Director :</b> <code>{mov_director}</code>"""
        ...
        paste = await telegraph_paste(f"IMDb Movie Result for “ {angel} ”", telegraph_)
        ...
        await hel_.edit(f"__No movie found with name {angel}.__")
