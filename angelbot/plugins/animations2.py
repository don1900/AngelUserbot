...
@bot.on(angel_cmd(pattern=f"indflag$", outgoing=True))
...
@bot.on(angel_cmd(pattern="stupid$"))
...
@bot.on(angel_cmd(pattern=f"evil$", outgoing=True))
...
@bot.on(angel_cmd(pattern="gnt$", outgoing=True))
...
@bot.on(angel_cmd(pattern="gmg$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"bombs$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"call$"))
...
async def _(event):
    ...
    animation_chars = [
        ...
        "`Call Connected.`",
        "`Secretary: Angelo This is Raj Bhawan. Who is this?`",
        f"`Me: Angelo this is` `{angel_mention}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: Angelo Sir, How are you!!`",
        "`Prime Minister: May I Know Who Is This?`",
        f"`Me: Yes sur, itz me` `{angel_mention}`",
...
@bot.on(angel_cmd(pattern=r"kill$"))
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [AngelBoy](https://t.me/Forgo10God) __to release your account__😏"
            )
        else:
...
@bot.on(angel_cmd(pattern=f"hypno$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"dick", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"candy$"))
...
@bot.on(angel_cmd(pattern="gangasta$"))
...
@bot.on(angel_cmd(pattern=f"bigoof$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"charging$"))
...
@bot.on(angel_cmd(pattern="unoob$", outgoing=True))
...
@bot.on(angel_cmd(pattern="menoob$", outgoing=True))
...
@bot.on(angel_cmd(pattern="uproo$", outgoing=True))
...
@bot.on(angel_cmd(pattern="mepro$", outgoing=True))
...
@bot.on(angel_cmd(pattern="thanos$", outgoing=True))
