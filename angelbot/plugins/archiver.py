...
@bot.on(angel_cmd(pattern="zip", outgoing=True))
...
@bot.on(angel_cmd(pattern="compress"))
...
@bot.on(angel_cmd(pattern="unzip"))
...
@bot.on(angel_cmd(pattern="unrar"))
...
@bot.on(angel_cmd(pattern="untar"))
