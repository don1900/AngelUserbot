...
GDNOON = [
    ...
    "`How I wish the sun could obey me for a second, to stop its scorching ride on my angelbot. So sorry it will be hot there. Don’t worry, the evening will soon come. I love you.`",
    "`I want you when I wake up in the morning, I want you when I go to sleep at night and I want you when I relax under the sun in the afternoon!`",
...
ANGELOSTR = [
    ...
    "What’s crackin’?",
    "Howdy, howdy ,howdy!",
    "Angelo, who's there, I'm talking.",
