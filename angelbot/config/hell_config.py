# IF YOU ARE HOSTING angelbot ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "Its_angelbot")
    MY_GROUP = os.environ.get("YOUR_GROUP", "angelbot_Chat")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/The-angelbot/angelbot")
